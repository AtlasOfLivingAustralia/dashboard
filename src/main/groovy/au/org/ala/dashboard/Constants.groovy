...
class Constants {
    ...
    class WebServices {
        ...
        final static String PARTIAL_URL_TAXA_WITH_IMAGES = "/occurrences/facets?facets=taxon_name&pageSize=0&q=multimedia:Image"

        final static String PARTIAL_URL_SPECIES_WITH_IMAGES = "/occurrences/facets?q=multimedia:Image%20AND%20(rank:species%20OR%20rank:subspecies)&facets=taxon_name&pageSize=0"

        final static String PARTIAL_URL_SUBSPECIES_WITH_IMAGES = "/occurrences/facets?q=multimedia:Image%20AND%20rank:subspecies&facets=taxon_name&pageSize=0"

        final static String PARTIAL_URL_TAXA_VP_COUNT = "/occurrences/facets?facets=taxon_name&pageSize=0&q=multimedia:Image"

        final static String PARTIAL_URL_TAXA_CS_COUNT = "/occurrences/facets?facets=taxon_name&pageSize=0&q=multimedia:Image%20AND%20provenance:%22Individual%20sightings%22"
