...
<div>
    <header id="page-header">
        <div class="inner">
            <nav id="breadcrumb"><ol><li><a href="http://www.ala.org.au">Home</a></li> <li class="last">Dashboard</li>
            </ol></nav>
    ...
    <section id="floatContainer">
        ...
        <div class='link-group click-thru' tabindex="1" id="datasets-topic">
            ...
            <table>
                <tr><td id="website">Harvested websites</td><td><span class="count"><db:formatNumber
                        value="${datasets.groups.website}"/></span></td></tr>
                <tr><td id="records">Occurrence record sets</td><td><span class="count"><db:formatNumber
                        value="${datasets.groups.records}"/></span></td></tr>
                <tr><td id="document">Document sets</td><td><span class="count"><db:formatNumber
                        value="${datasets.groups.document}"/></span></td></tr>
                <tr><td id="uploads">Uploaded record sets</td><td><span class="count"><db:formatNumber
                        value="${datasets.groups.uploads}"/></span></td></tr>
            </table>
        ...
        <div class='link-group click-thru' tabindex="2" id="basis-topic">
            ...
            <g:if test="${basisOfRecord.error.asBoolean()}"><p class="error"
                                                               title="${basisOfRecord.reason}">${basisOfRecord.error}</p></g:if>
            <table>
                <tbody>
        ...
        <div class='link-group' id="collections-topic" tabindex="3">
            <h2><a href="http://collections.ala.org.au"><span class="count">${collections.total}</span></a> Collections
            </h2>
        ...
        <div class='link-group' tabindex="6" id="spatial-topic">
            <h2><a href="http://spatial.ala.org.au/layers"><span class="count">${spatialLayers.total}</span>
            </a> Spatial layers</h2>
            <table>
        ...
        <div class='link-group' tabindex="8" id="identifyLife-topic">
            ...
            <a target="_blank" href="http://www.identifylife.org/"><g:img dir="images/dashboard"
                                                                          file="identify-life-2.png"/></a>
        ...
        <div class='link-group click-thru' tabindex="9" id="most-topic">
            ...
            <div id="mostRecorded">
                <g:if test="${mostRecorded.error.asBoolean()}"><p class="error"
                                                                  title="${basisOfRecord.reason}">${mostRecorded.error}</p></g:if>
                <table>
        ...
        <div class='link-group' tabindex="10" id="typeStatus-topic">
            <h2><a href="http://biocache.ala.org.au/occurrences/search?q=type_status:[*%20TO%20*]&fq=-type_status:notatype"><span
                    class="count"><db:formatNumber value="${typeCounts.total}"/></span></a>Type specimens</h2>
        ...
        <div class='link-group' tabindex="11" id="bold-topic">
            <h2>Barcode of life <a target="_blank" href="http://bold.ala.org.au/"><g:img dir="images/dashboard"
                                                                                         file="bold.png"/></a></h2>
        ...
        <g:if test="${volunteerPortalCounts}">
            <div class='link-group' tabindex="13" id="bvp-topic">
                <h2><a target="_blank" href="http://volunteer.ala.org.au/">DigiVol <smaller>(Volunteer portal)</smaller>
                </a></h2>
                <table>
                    <tbody>
        ...
        <div class='link-group' tabindex="21" id="reason-breakdown-topic">
            ...
            <div id="reasonBreakdown">
                <table id="loggerReasonBreakdownTable">
                    ...
                    <tr><td colspan="3"><a href="javacript:void(0);" id="showAllLoggerReasons">more/less...</a></td>
                    </tr>
                </table>
            </div>
        </div>
